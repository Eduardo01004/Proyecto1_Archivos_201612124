...
void Ejecutar::Ejec(char lexema[400], char token[400], int flag){
    ...
    case 1:
        if (strcmp(lexema,"path") == 0){
            ...
            estadoexec = 0;
            flag = 0;
            cout << "Parametro path obligatorio exec" << endl;
        }
        break;
    case 2:
        if(strcmp(lexema,"palabra") == 0){
            estadoexec = 3;
            strcpy(adress,token);
        }else{
            estadoexec = 0;
    ...
    case 3:
        ...
        if (strcmp(lexema,"finInstruccion") == 0){
            ...
            if(archivo = fopen(adress,"rb+")){
                ...
                printf("Error no existe la direccion del exec\n");
            }
...
void Ejecutar:: Concatenar2(char *p,QString direccion){
    char palabra[400];
    int espacio = 0;
    int recien = 0;
    int contador = 0;
                ...
                if (espacio == 0 && recien == 0){
                    if (comillas == 1 || comentario == 1){
                        ...
                        if (numero == true) {
                           ...
                           fprintf( archivo,"%s,%s\n", palabra , palabrasReservadas22(palabra) );
                       }
                        memset(palabra, 0, sizeof(palabra));
                        palabra[0] = '\0';
                        contador = 0;
